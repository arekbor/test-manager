...
final class CreateStartAppSettingsHandler
{
    ...
    public function __invoke(CreateStartAppSettings $command): void
    {
        $startAppSettings = [
        ...
        $this->appSettingManager->createMany(...$startAppSettings);
    }
}