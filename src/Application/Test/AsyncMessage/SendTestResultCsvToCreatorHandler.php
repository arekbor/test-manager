...
use App\Application\Shared\Bus\AsyncMessageBusHandlerInterface;
...
final class SendTestResultCsvToCreatorHandler implements AsyncMessageBusHandlerInterface
{
    ...
    public function __invoke(SendTestResultCsvToCreator $message): void
    {
        try {
